const getWordsData = async function name() {
  const response = await fetch(
    'https://api.wordnik.com/v4/words.json/randomWords?limit=500&hasDictionaryDef=true&excludePartOfSpeech=proper-noun,abbreviation&minCorpusCount=5000&minLength=3&maxLength=12&api_key=3we3tm2pohigikot1l08soicb6y4sgoqare3wzgrpbc5gif4v',
  )
